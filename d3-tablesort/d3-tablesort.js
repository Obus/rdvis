...
(function(globals) {
    ...
    globals.TableSort = function(table, table_caption, columns, data, dimensions) {
        ...
        outerTable
            ...
            .append("caption").text(table_caption)
        ...
        rows.selectAll("td")
            ...
            .attr('width', function (d) { return Math.max((d.toString().length * 10), 20) + 'px'; });
        ...
        outerTable.selectAll('.header-table tr th')
            ...
            .style('width', function(d) { this.style.width = d + '0px'; return 1; });


        //rows.attr("style", "height:" + "10px");
